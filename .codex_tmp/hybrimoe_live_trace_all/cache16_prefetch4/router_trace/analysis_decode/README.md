...
- trace_path: /root/autodl-tmp/hybrimoe_live_trace/cache16_prefetch4/router_trace/router_trace.jsonl
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| no_prefetch | 0.2272 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 4340.0 | 1085 | 0.0000 | False |
| history_prefetch | 0.2528 | 0.0287 | 0.4568 | 0.3712 | 0.4745 | 3764.0 | 1591 | 0.5517 | False |
| utility_gate | 0.2272 | 0.0000 | 0.4186 | 0.0000 | 0.0000 | 4340.0 | 1085 | 0.0000 | False |

## Delta: history_prefetch - no_prefetch

- cache_hit_delta: 0.0256
- stall_time_delta: -576.0
- bytes_moved_delta: 506
- demand_bytes_delta: -356

## Gate Check

- utility_gate_prefetch_issued: 0
- history_prefetch_issued: 862
