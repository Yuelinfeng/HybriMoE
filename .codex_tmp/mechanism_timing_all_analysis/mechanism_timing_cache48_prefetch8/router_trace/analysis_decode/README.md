...
- trace_path: /root/autodl-tmp/hybrimoe_live_trace/mechanism_timing_cache48_prefetch8/router_trace/router_trace.jsonl
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| no_prefetch | 0.7356 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 4124.0 | 1031 | 0.0000 | False |
| history_prefetch | 0.7451 | 0.0085 | 0.9551 | 0.4261 | 0.0957 | 3839.0 | 1126 | 0.5455 | True |
| utility_gate | 0.7356 | 0.0000 | 0.9509 | 0.0000 | 0.0000 | 4124.0 | 1031 | 0.0000 | True |

## Delta: history_prefetch - no_prefetch

- cache_hit_delta: 0.0095
- stall_time_delta: -285.0
- bytes_moved_delta: 95
- demand_bytes_delta: -135

## Gate Check

- utility_gate_prefetch_issued: 0
- history_prefetch_issued: 230
